...
Traceback (most recent call last):
  File "/tmp/tmp0onp3r6c/test1.py", line 46, in <module>
  File "/tmp/tmp0onp3r6c/test1.py", line 40, in main
...
Traceback (most recent call last):
  File "/tmp/tmp0onp3r6c/test2.py", line 47, in <module>
  File "/tmp/tmp0onp3r6c/test2.py", line 40, in main
  File ".../05.py", line 2, in reachNumber
NameError: name 'v1' is not defined
